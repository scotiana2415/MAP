...
public class ThirdExercise {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("1. [1, 3, 0, 0, 0, 0, 0, 0, 0] + [8, 7, 0, 0, 0, 0, 0, 0, 0] = " + Arrays.toString(exercise.add(firstNumber, secondNumber)));
        System.out.println("2. [8, 3, 0, 0, 0, 0, 0, 0, 0] - [5, 4, 0, 0, 0, 0, 0, 0, 0] = " + Arrays.toString(exercise.subtract(thirdNumber, fourthNumber)));
        System.out.println("3. [2, 3, 6, 0, 0, 0, 0, 0, 0] * 2 = " + Arrays.toString(exercise.multiply(fifthNumber, 2)));
        System.out.println("4. [2, 3, 6, 0, 0, 0, 0, 0, 0] / 2 = " + Arrays.toString(exercise.divide(fifthNumber, 2)));
        System.out.println("");
    }
}
